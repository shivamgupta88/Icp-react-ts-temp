...
var require_buffer2 = __commonJS({
  "node_modules/borc/node_modules/buffer/index.js"(exports2) {
    ...
    Buffer3.from = function(value3, encodingOrOffset, length) {
    ...
    Buffer3.prototype.writeUintLE = Buffer3.prototype.writeUIntLE = function writeUIntLE2(value3, offset, byteLength2, noAssert) {
      value3 = +value3;
      offset = offset >>> 0;
      byteLength2 = byteLength2 >>> 0;
      if (!noAssert) {
    ...
    Buffer3.prototype.writeUint8 = Buffer3.prototype.writeUInt8 = function writeUInt8(value3, offset, noAssert) {
      value3 = +value3;
      offset = offset >>> 0;
      if (!noAssert)
    ...
    Buffer3.prototype.writeUint16BE = Buffer3.prototype.writeUInt16BE = function writeUInt16BE(value3, offset, noAssert) {
      value3 = +value3;
      offset = offset >>> 0;
      if (!noAssert)
        checkInt(this, value3, offset, 2, 65535, 0);
    ...
    Buffer3.prototype.writeUint32BE = Buffer3.prototype.writeUInt32BE = function writeUInt32BE(value3, offset, noAssert) {
      value3 = +value3;
      offset = offset >>> 0;
      if (!noAssert)
        checkInt(this, value3, offset, 4, 4294967295, 0);
    ...
    Buffer3.prototype.writeIntLE = function writeIntLE2(value3, offset, byteLength2, noAssert) {
      value3 = +value3;
      offset = offset >>> 0;
      if (!noAssert) {
    ...
    Buffer3.prototype.writeFloatLE = function writeFloatLE(value3, offset, noAssert) {
      return writeFloat(this, value3, offset, true, noAssert);
    };
    Buffer3.prototype.writeFloatBE = function writeFloatBE(value3, offset, noAssert) {
    ...
    Buffer3.prototype.writeDoubleLE = function writeDoubleLE(value3, offset, noAssert) {
      return writeDouble(this, value3, offset, true, noAssert);
    };
    Buffer3.prototype.writeDoubleBE = function writeDoubleBE(value3, offset, noAssert) {
...
var FuncClass = class extends ConstructType {
  ...
  encodeValue([principal, methodName]) {
    ...
    return concat2(new Uint8Array([1]), canister, methodLen, method2);
  }
  _buildTypeTableImpl(T) {
...
var UnverifiedCertificateError = class extends AgentError {
  constructor() {
...
var Certificate = class {
  constructor(response, _agent = getDefaultAgent()) {
    ...
    this.verified = false;
    this._rootKey = null;
    this.cert = decode3(new Uint8Array(response.certificate));
  }
  lookup(path) {
    this.checkState();
 ...
 * @license MIT
 */
//# sourceMappingURL=chunk-EXNKUELN.js.map
